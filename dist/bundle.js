...
module.exports = JSON.parse("{\"level1\":{\"map\":[[\"w\",\"w\",\"w\",\"w\",\"w\",\"w\",\"w\",\"w\",\"w\",\"w\"],[\"w\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"w\"],[\"w\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"w\"],[\"w\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"w\"],[\"w\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"w\"],[\"w\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"w\"],[\"w\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"w\"],[\"w\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"w\"],[\"w\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"e\",\"w\"],[\"w\",\"w\",\"w\",\"w\",\"w\",\"w\",\"w\",\"w\",\"w\",\"w\"]],\"gameObjects\":[{\"elementId\":\"player\",\"class\":\"p\",\"type\":\"player\",\"position\":{\"x\":5,\"y\":1}},{\"elementId\":\"body_0\",\"class\":\"p\",\"type\":\"snakeBody\",\"position\":{\"x\":4,\"y\":1}},{\"elementId\":\"body_1\",\"class\":\"p\",\"type\":\"snakeBody\",\"position\":{\"x\":3,\"y\":1}},{\"elementId\":\"body_2\",\"class\":\"p\",\"type\":\"snakeBody\",\"position\":{\"x\":2,\"y\":1}},{\"elementId\":\"body_3\",\"class\":\"p\",\"type\":\"snakeBody\",\"position\":{\"x\":1,\"y\":1}}]}}");
...
/* harmony import */ var _snakeBody__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./snakeBody */ "./src/snakeBody.js");
...
class Game {
  ...
  init(levels) {
    ...
    levels.level1.map.forEach((row, x) => {
      row.forEach((item, y) => {
        if (item === 'w') {
          obstacles.push(new _obstacle__WEBPACK_IMPORTED_MODULE_2__["Obstacle"](`${item}_${x}_${y}`, x, y));
        }
      });
    });
    let player;
    levels.level1.gameObjects.forEach(gameObject => {
      switch (gameObject.type) {
        case 'player':
          player = new _player__WEBPACK_IMPORTED_MODULE_0__["Player"](gameObject.elementId, gameObject.position.x, gameObject.position.y);
          player.collisionObservers.push(this);
          break;

        case 'snakeBody':
          {
            const bodyPart = new _snakeBody__WEBPACK_IMPORTED_MODULE_1__["SnakeBody"](gameObject.elementId, gameObject.position.x, gameObject.position.y);
...
class Player extends _gameObject__WEBPACK_IMPORTED_MODULE_0__["GameObject"] {
  ...
  init(x, y) {
    ...
    this.speed = 3;
    this.obstacles = [];
    this.collisionObservers = []; // const container = document.querySelector('#container');
...
/*!**************************!*\
  !*** ./src/snakeBody.js ***!
  \**************************/
/*! exports provided: SnakeBody */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SnakeBody", function() { return SnakeBody; });
/* harmony import */ var _gameObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gameObject */ "./src/gameObject.js");


class SnakeBody extends _gameObject__WEBPACK_IMPORTED_MODULE_0__["GameObject"] {}
